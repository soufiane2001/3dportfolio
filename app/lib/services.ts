...
export const services: Record<string, ServicePageData> = {
  "creation-site-web-casablanca": {
    ...
    audienceHeading: "Création de sites professionnels pour entreprises à Casablanca",
    benefitsHeading: "Site vitrine, e-commerce et développement sur mesure",
    processHeading: "Les étapes de création de votre site internet",
    faqHeading: "Prix, délais et référencement d’un site web",
  ...
  "site-vitrine-casablanca": {
    ...
    audienceHeading: "Un site vitrine professionnel pour présenter votre entreprise",
    benefitsHeading: "Une présence crédible, rapide et pensée pour le mobile",
    processHeading: "De vos contenus à la mise en ligne du site vitrine",
    faqHeading: "Questions sur le prix et la gestion d’un site vitrine",
  ...
  "creation-site-ecommerce-casablanca": {
    ...
    audienceHeading: "Une boutique en ligne adaptée à votre catalogue et vos clients",
    benefitsHeading: "Catalogue, commandes et administration e-commerce",
    processHeading: "Construire un parcours d’achat efficace étape par étape",
    faqHeading: "Paiement, gestion et SEO de votre boutique en ligne",
  ...
  "application-mobile-casablanca": {
    ...
    audienceHeading: "Une application Android et iOS pensée pour ses utilisateurs",
    benefitsHeading: "React Native, Expo et backend connecté",
    processHeading: "Du prototype au build de votre application mobile",
    faqHeading: "Budget, MVP et publication d’une application mobile",
  ...
  "referencement-seo-casablanca": {
    ...
    audienceHeading: "Un référencement naturel fondé sur un diagnostic concret",
    benefitsHeading: "SEO technique, contenu utile et visibilité locale",
    processHeading: "De l’audit SEO au suivi des corrections",
    faqHeading: "Délais, résultats et référencement local à Casablanca",
